...
public class AtmAdmin extends JFrame implements ActionListener  {
			...
			while ((thisLine = br.readLine()) != null) {   //read a line form Documents
				...
				if (textFieldCardNo.getText().equals(parts[0]))  //Checking user input to the line parsts 0
					...
					JOptionPane.showMessageDialog(null, "Successfully");
                                        ...
                                        PinValidationAdmin pinValidaionAdmin = new PinValidationAdmin(textFieldCardNo.getText()); //create new object
                                        pinValidaionAdmin.setVisible(true);
                                }
                                else
                                    JOptionPane.showMessageDialog(null, "Account No is wrong Privide Correct Account Number");
				}
				br.close();
